// host_single_FPGA_SIFT: the complete implementation for single FPGA
...
// Usage (e.g.): ./host_single_FPGA_SIFT 10.253.74.24 8881 5001 1 32
...
{ 
    ...
    std::string gnd_dir = "/mnt/scratch/wenqi/Faiss_experiments/bigann/SIFT_gnd/";
