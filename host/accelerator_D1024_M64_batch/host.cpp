...
int main(int argc, char **argv) {
	...
	std::string data_dir_prefix = "/mnt/scratch/wenqi/Faiss_Enzian_U250_index/RALM-L1000M_IVF32768,PQ64";
    ...
    std::string product_quantizer_dir_suffix("product_quantizer_float32_64_256_16_raw");
